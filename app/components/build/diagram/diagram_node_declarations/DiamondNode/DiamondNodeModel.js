...
export default class DiamondNodeModel extends NodeModel {
  ...
  constructor(message: string, data: {} = {}) {
    ...
    this.outPortTrue = this.addPort(
      new DiamondPortModel('bottom', false, <font color="black">True</font>)
    );
    this.outPortFalse = this.addPort(
      new DiamondPortModel('right', false, <font color="black">False</font>)
    );
  }
  ...
  deSerialize(object: {name: string, data: {}}, engine: DiagramEngine): void {
    ...
    this.outPortTrue.label = <font color="black">True</font>;
    this.outPortFalse = this.getPort('right');
    this.outPortFalse.label = <font color="black">False</font>;
  }
